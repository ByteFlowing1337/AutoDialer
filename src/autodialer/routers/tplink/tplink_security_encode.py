...
def tplink_security_encode(password):
    key = "RDpbLfCPsJZ7fiv"
    dictionary = (
        "yLwVl0zKqws7LgKPRQ84Mdt708T1qQ3Ha7xv3H7NyU84p21Bri"
        "UWBU43odz3iP4rBL3cD02KZciXTysVXiV8ngg6vL48rPJyAUw0HurW20xqxv9aYb4M9"
        "wK1Ae0wlro510qXeU07kV57fQMc8L6aLgMLwygtc0F10a0Dg70TOoouy"
        "FhdysuRMO51yY5ZlOZZLEal1h0t9YQW0Ko7oBwmCAHoic4HYbUyVeU3sfQ1x"
        "tXcPcf1aT303wAQhv66qzW"
    )
    d = ""
    f = len(password)
    g = len(key)
